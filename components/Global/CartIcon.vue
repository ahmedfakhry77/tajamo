<template>
  <div class="relative"  @mouseover="showCartDropdown = true" @mouseleave="showCartDropdown = false">
    <button
      @click="toggleCart"
    ...
    <div
      ...
      @mouseover="showCartDropdown = true" @mouseleave="showCartDropdown = false"
      ...
      <div class="p-4">
        ...
        <div v-else class="space-y-3 max-h-64 overflow-y-auto">
          ...
          >
            ...
            <div class="flex-1">
              <p class="text-sm font-medium text-gray-900">Product #{{ item.productId }}</p>
