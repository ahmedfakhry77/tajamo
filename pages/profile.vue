          ...
          <form @submit.prevent="updateProfile" class="space-y-6">
            ...
            <div class="flex justify-end pt-4">
              <button
                ...
                class=" bg-scimaGold text-white px-6 py-2 rounded-md hover:bg-scimaGoldHover focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
              >
